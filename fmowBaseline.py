...
from data_ml_functions.data_functions import prepare_data,calculate_class_weights
# from data_ml_functions.dataFunctionForExcel import generate_excel_from_metadata
import numpy as np
import os
...
class FMOWBaseline:
    def __init__(self, params=None, argv=None):
        ...
        for arg in argv:
            if arg == '-prepare':
                prepare_data(params)
                # generate_excel_from_metadata(params)
                # calculate_class_weights(params)
            # if arg == '-generate_excel':
            #     generate_excel_files(params)
            performAll = (arg == '-all')
